...
if !exists("g:formatprg_args_expr_cs") && !exists("g:formatprg_args_cs")
    let g:formatprg_args_expr_cs = '"--mode=cs --style=google --indent-namespaces -pcH".(&expandtab ? "s".&shiftwidth : "t")'
endif

if !exists("g:formatprg_c") | let g:formatprg_c = "astyle" | endif
if !exists("g:formatprg_args_expr_c") && !exists("g:formatprg_args_c")
    let g:formatprg_args_expr_c = '"--mode=c --style=google -pcH".(&expandtab ? "s".&shiftwidth : "t")'
endif
...
if !exists("g:formatprg_args_expr_java")  && !exists("g:formatprg_args_java")
    let g:formatprg_args_expr_java = '"--mode=java --style=google -pcH".(&expandtab ? "s".&shiftwidth : "t")'
endif
